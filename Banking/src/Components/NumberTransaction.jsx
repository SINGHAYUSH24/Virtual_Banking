...
import styles from "../assets/NumberTransaction.module.css";
...
function NumberTransaction(){
    ...
    const [receiverNumber,setReceiver]=useState();
    useEffect(()=>{
    ...
    return(
      ...
      <div className={styles.formCard}>
        ...
        <div className={styles.fieldGroup}>
          <label htmlFor="receiver_number" className={styles.fieldLabel}>
