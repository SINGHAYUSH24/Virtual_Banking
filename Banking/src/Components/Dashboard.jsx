    ...
    <div className={styles.dashboardWrapper}>
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.actionsSection}>
          <h2 className={styles.sectionTitle}>Transfers Options</h2>
          <div className={styles.actionsGrid}>
            <button className={styles.actionCard} onClick={() => { navigate("/qr", { state: { data: data } }) }}>
              <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 448 448" enable-background="new 0 0 448 448" xml:space="preserve" width="64px" height="64px" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path fill="#161212" d="M288,0v160h160V0H288z M416,128h-96V32h96V128z"></path> <rect x="64" y="64" fill="#000000" width="32" height="32"></rect> <rect x="352" y="64" fill="#000000" width="32" height="32"></rect> <polygon fill="#000000" points="256,64 224,64 224,32 256,32 256,0 192,0 192,96 224,96 224,128 256,128 "></polygon> <path fill="#000000" d="M160,160V0H0v160h32H160z M32,32h96v96H32V32z"></path> <polygon fill="#000000" points="0,192 0,256 32,256 32,224 64,224 64,192 "></polygon> <polygon fill="#000000" points="224,224 256,224 256,160 224,160 224,128 192,128 192,192 224,192 "></polygon> <rect x="352" y="192" fill="#000000" width="32" height="32"></rect> <rect x="416" y="192" fill="#000000" width="32" height="32"></rect> <polygon fill="#000000" points="320,256 320,288 352,288 352,320 384,320 384,256 352,256 352,224 320,224 320,192 288,192 288,224 256,224 256,256 "></polygon> <rect x="384" y="224" fill="#000000" width="32" height="32"></rect> <path fill="#000000" d="M0,288v160h160V288H0z M128,416H32v-96h96V416z"></path> <polygon fill="#000000" points="256,256 224,256 224,224 192,224 192,192 96,192 96,224 64,224 64,256 128,256 128,224 160,224 160,256 192,256 192,288 224,288 224,320 256,320 "></polygon> <rect x="288" y="288" fill="#000000" width="32" height="32"></rect> <rect x="416" y="256" fill="#000000" width="32" height="64"></rect> <rect x="320" y="320" fill="#000000" width="32" height="32"></rect> <rect x="384" y="320" fill="#000000" width="32" height="32"></rect> <rect x="64" y="352" fill="#000000" width="32" height="32"></rect> <polygon fill="#000000" points="320,384 320,352 288,352 288,320 256,320 256,352 224,352 224,320 192,320 192,384 224,384 224,416 256,416 256,384 "></polygon> <polygon fill="#000000" points="352,384 320,384 320,416 352,416 352,448 384,448 384,352 352,352 "></polygon> <rect x="416" y="352" fill="#000000" width="32" height="32"></rect> <rect x="192" y="416" fill="#000000" width="32" height="32"></rect> <rect x="256" y="416" fill="#000000" width="64" height="32"></rect> <rect x="416" y="416" fill="#000000" width="32" height="32"></rect> </g> </g></svg>
              Receive Using QRcode</button>
            ...
            <button className={styles.actionCard} onClick={() => { navigate("/payment", { state: { data: data } }) }}>
              <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M17 15V17.8C17 18.9201 17 19.4802 16.782 19.908C16.5903 20.2843 16.2843 20.5903 15.908 20.782C15.4802 21 14.9201 21 13.8 21H8.2C7.0799 21 6.51984 21 6.09202 20.782C5.71569 20.5903 5.40973 20.2843 5.21799 19.908C5 19.4802 5 18.9201 5 17.8V5.57143C5 5.04025 5 4.77465 5.05014 4.55496C5.2211 3.80597 5.80597 3.2211 6.55496 3.05014C6.77465 3 7.04025 3 7.57143 3H11M10 18H12M19 4.50003C18.5 4.37601 17.6851 4.37145 17 4.37601M17 4.37601C16.7709 4.37754 16.9094 4.3678 16.6 4.37601C15.7926 4.4012 15.0016 4.73678 15 5.68753C14.9982 6.70037 16 7.00003 17 7.00003C18 7.00003 19 7.23123 19 8.31253C19 8.31253 19 8.31253 19 8.31253C19 9.12512 18.1925 9.48118 17.1861 9.59908C16.3861 9.59908 16 9.62503 15 9.50003M17 4.37601L17 3M17 9.5995V11" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
              Mobile Number </button>
            <button className={styles.actionCard} onClick={() => { navigate("/payees", { state: { data: data } }) }}>
              <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM6 8a6 6 0 1 1 12 0a6 6 0 0 1-12 0zm1.89 9.11a3.003 3.003 0 0 0-2.89 3.01c0 .48.39.88.88.88h12.24c.49 0 .88-.4.88-.88a3.003 3.003 0 0 0-2.89-3.01c-3.14-.61-4.88-.61-8.12 0zm1.09-1.92c2.33-.69 3.71-.69 6.04 0a5.004 5.004 0 0 1 4.86 5.06c0 1.57-1.28 2.75-2.86 2.75H7.02c-1.58 0-2.86-1.18-2.86-2.75a5.004 5.004 0 0 1 4.86-5.06z" fill="#000000"></path> </g></svg>
